...
| `auto-plan-dev` | 仅在用户显式点名时，把已确认需求文档或功能需求生成为带需求映射、原型承接、建议项状态跟踪和页面技术实现约束的开发计划。 |
...
| `requirement-doc-generator` | 基于已确认需求闭环和项目现状，生成带稳定需求编号、建议项处理状态、页面交互约束和必要 `prototypes/` 原型文件的正式 `requirement.md`。 |
